...
from proxycraft.shared.networking.connection_pooling.connectors.context_connector import (
...
from proxycraft.shared.networking.connection_pooling.connectors.thread_local_connector import (
...
class HTTPClient:
    ...
    async def __aexit__(self, exc_type, exc_val, exc_tb):
        ...
        if (
            ...
            and self.tcp_connector
            and not self.tcp_connector.closed
        ):
